    ...
    <div className="text-[10px] leading-tight font-sans text-black">
      ...
      <div className="flex justify-between items-start mb-4 border-b pb-2">
         ...
         <div className="text-center flex-1 px-4">
            ...
            <h2 className="font-bold text-xs uppercase">Hospital General de Zona</h2>
            <h3 className="font-bold text-xs mt-1">SERVICIO DE MEDICINA INTERNA</h3>
      ...
      <div className="mb-2 border border-black p-1">
         ...
         <div className="grid grid-cols-2 gap-4">
             ...
             <div className="border-r border-dotted border-black pr-2">
                 ...
                 <div className="mt-1 italic">{data.ecg_otras_alteraciones || data.otrasAlteracionesEcg}</div>
             </div>
